...
<html>
	...
	<body>
	    <div class="content">
	        <h1>WatchList: </h1>
	        <%
	        	String command = "where auction_id = any "
	        				   + "(select auction_id from watchlist where buyer_username = \'" 
	        				   + session.getAttribute("USERNAME") + "\')";
	        	out.print(new AuctionQuery(command));
	        %>
	    </div>
	</body>
